...
<div class="edit-container max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg">
	...
	<form on:submit|preventDefault={handleEditPost} class="space-y-6">
		<div>
				...
				<div use:dndzone={{items: images, type: 'images', flipDurationMs: DND_FLIP_DURATION}} 
					...
					{#each images as image (image.id)}
						<div class="relative group" animate:flip={{duration: DND_FLIP_DURATION}}>
							<img src={image.url} alt="업로드된 이미지" class="w-full aspect-square object-cover rounded-lg shadow-md" />
